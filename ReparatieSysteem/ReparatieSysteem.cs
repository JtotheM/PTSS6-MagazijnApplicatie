...
{
    public class ReparatieSysteem : IReparatieSysteem, IDisposable
    {
        private IDatabase database;
        private IMailServer mailServer;
        private JMS.JMSQueue mJMSQueue;
        ...
        public ReparatieSysteem()
        {
            ...
            mJMSQueue = new JMS.JMSQueue("86.86.7.186:61616");
            mJMSQueue.OnMessage += mJMSQueue_OnMessage;
            mJMSQueue.Connect();
        }

        void mJMSQueue_OnMessage(Apache.NMS.IMessage aMessage)
        {
            Apache.NMS.ITextMessage pMessage = aMessage as Apache.NMS.ITextMessage;
            dynamic pRequest = Newtonsoft.Json.JsonConvert.DeserializeObject(pMessage.Text);
            //Do Stuff With Request

            //Reply With other stuff
            mJMSQueue.SendMessage(aMessage.NMSMessageId, "5300");
